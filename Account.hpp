...
Jonel Muncan
11/21/22
Declares member methods and variables of Account
Initializes LL of posts and vector of following
...
public:
   ...
   */
    ...
    std::vector<Post*> increasingPriorityOldestToNewestHELPER();


    std::vector<Post*> increasingPriorityNewestToOldestHELPER();


    std::vector<Post*> decreasingPriorityOldestToNewestHELPER();


    std::vector<Post*> decreasingPriorityNewestToOldestHELPER();
...
private:
    ...
    Post* maxLikesPost_ = nullptr;
    Post* minLikesPost_ = nullptr;

    std::vector<Post*> lowPriority_;
    std::vector<Post*> medPriority_;
    std::vector<Post*> highPriority_;
